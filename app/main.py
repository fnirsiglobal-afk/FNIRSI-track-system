...
def extract_track_fields(track_info: dict) -> dict:
    ...
    sub_status_desc = latest_status.get("sub_status_descr") or ""
    # 如果 17TRACK 没有返回描述，用本地映射补充
    if not sub_status_desc and sub_status:
        sub_status_desc = SUB_STATUS_CN.get(sub_status, sub_status)
    ...
    fields = {
        FIELD_SUB_STATUS:      sub_status or None,
